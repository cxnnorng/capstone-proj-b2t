...
Folder notes:
- src/evaluation_metrics/ contains predicted sentence outputs and JSON metric files generated by evaluation for each model.
- src/trained_models/ contains checkpoints for all experiment versions, PNG training curves for each version, and the training-curve generator script.